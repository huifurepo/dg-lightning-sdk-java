...
public class BasePayClient {
    ...
    public Map<String, Object> getOptionalBizParams() {
        return optionalBizParams;
    }
    public BasePayClient injectBizParam(String key, Object value) {
        this.optionalBizParams.put(key, value);
        return this;
    }
    public    BasePayClient optional(String key, Object value){
       injectBizParam(key, value);
        return this;
    }
